...
$GETH --port $P2P_PORT --nodiscover --networkid 1234 --datadir $DATADIR --http --http.port $HTTP_PORT --http.api debug,personal,eth,net,web3,txpool,admin,miner $MINER_ARGS
